  ...
  factory Rajaongkir.fromJson(Map<String, dynamic> json) {
    return Rajaongkir(
      ...
      originDetails: json["origin_details"] == null
          ? null
          : NDetails.fromJson(json["origin_details"]),
      destinationDetails: json["destination_details"] == null
          ? null
          : NDetails.fromJson(json["destination_details"]),
      results: json["results"] == null
          ? []
          : List<Result2>.from(
              json["results"]!.map((x) => Result2.fromJson(x))),
    );
  }
}
...
class Courier {
  ...
  // Convert a Courier object into a map
  ...
  // Create a Courier object from a map
